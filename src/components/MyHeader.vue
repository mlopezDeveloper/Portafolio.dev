<template>
    <header class="select-none">
        <div class="m-5 flex items-center">
            ...
            <div class="py-4 mr-10">
                <div class="absolute w-40 h-40 bg-dots-pattern transform -translate-x-6 -translate-y-6 z-0"></div>
                ...
                <div class="absolute w-40 h-40 bg-dots-pattern transform translate-x-48 -translate-y-36 z-[-1]"></div>
            </div>
            <!-- <div class="flex flex-col justify-center pl-8 pr-4 space-y-7">
