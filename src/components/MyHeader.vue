<template>
    <section class="select-none">
        <div class="m-5 flex items-center">
            ...
            <div class="py-4">
                <div class="py-4">
                    <div class="shadow-lg bg-gradient-to-r from-violet-600 to-indigo-600 rounded-[20rem] overflow-hidden">
                        <img class="h-30 w-auto scoped shadow-md" src="../assets/fperfil.png" alt="Foto de perfil de Marcos López" />
                    </div>
                </div>
