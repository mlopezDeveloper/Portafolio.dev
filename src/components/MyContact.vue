        ...
        <div class="grid grid-cols-2 gap-4 items-center">
            <div class="flex flex-col items-center mt-10">
                ...
                <div class="uppercase text-center">
                    <p class="mt-4">Desarrollando mis sueños desde Argentina - Buenos Aires </p>
                    <p class="mt-4">© 2024 portafolio v.2 por mlopez.</p>
                </div>
            </div>
            <div class="bg-gray-900 text-white mt-10 rounded-lg mx-32 max-w-2xl px-4 py-16 sm:px-6 sm:py-6 lg:max-w-7xl lg:px-6">
